...
BEGIN
    ...
    IF tmpl_id IS NOT NULL THEN
        ...
        (tmpl_id, 4, 'Weź antybiotyk + lek przeciwbólowy. Przyjedź na zabieg.', 'Przyjmij antybiotyk (1g) i lek przeciwbólowy (Ibuprofen 400mg). Przyjedź do gabinetu 30 minut przed planowaną godziną zabiegu.', '🏥', -1, false, '🏥 Za godzinę Twój zabieg! Weź antybiotyk + lek przeciwbólowy i wyruszaj do gabinetu.', true, NULL, NULL, NULL, 0),
