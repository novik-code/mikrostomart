...
const PUBLIC_PATHS = [
    '', '/o-nas', '/oferta', '/oferta/implantologia', '/oferta/all-on-4', '/oferta/laser', '/oferta/periodontologia', '/oferta/stomatologia-dziecieca', '/oferta/stomatologia-zachowawcza', '/oferta/leczenie-kanalowe',
