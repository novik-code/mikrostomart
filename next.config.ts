...
import { PUBLICZNE_PLIKI_PRECACHE } from "./src/lib/swPrecachePubliczne";
...
const withSerwist = withSerwistInit({
  ...
  // 2026-09-17: z /public do precache idą TYLKO manifest i ikony PWA. Wcześniej wzorzec
  // obejmował wszystkie obrazki (284 MB). Pliki .avif i .html zwracały 404, więc instalacja
  // service workera padała u wszystkich i ruszała od nowa przy każdej wizycie.
  // Uzasadnienie i pułapki: src/lib/swPrecachePubliczne.ts.
  globPublicPatterns: PUBLICZNE_PLIKI_PRECACHE,
});
