    ...
    if (step === 'PAYMENT' && clientSecret) {
        return (
            <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
                <div>
                    <h4 style={{ color: '#9ca3af', fontSize: '0.9rem', marginBottom: '0.5rem', textTransform: 'uppercase', letterSpacing: '1px' }}>{t('shippingAddress')}</h4>
                ...
                <div style={{ padding: '1rem', background: 'rgba(255,255,255,0.02)', borderRadius: '8px' }}>
                    {!process.env.NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY ? (
                        <div style={{ padding: '1rem', color: '#ef4444', border: '1px dashed #ef4444', borderRadius: '8px' }}>
                            <strong>{t('noPaymentConfig')}</strong>
