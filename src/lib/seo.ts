...
const BREADCRUMB_LABELS: Record<string, Record<string, string>> = {
    pl: {
        ...
        laser: 'Stomatologia Laserowa',
        periodontologia: 'Periodontologia',
        'stomatologia-dziecieca': 'Stomatologia Dziecięca',
        'stomatologia-zachowawcza': 'Stomatologia Zachowawcza',
        ...
        nowosielski: 'Blog Marcina Nowosielskiego',
        ...
        'all-on-4-opole': 'All-on-4 / All-on-6 w Opolu',
        'licowki-opole': 'Licówki w Opolu',
        'metamorfoza-usmiechu-opole': 'Metamorfoza uśmiechu w Opolu',
    ...
    en: {
        ...
        'stomatologia-dziecieca': 'Pediatric Dentistry',
        ...
        nowosielski: "Marcin Nowosielski's Blog",
        ...
        zespol: 'Team',
        'marcin-nowosielski': 'Dentist Marcin Nowosielski M.Sc.',
        'elzbieta-nowosielska': 'Elżbieta Nowosielska, Dental Hygienist',
        'implanty-opole': 'Dental Implants in Opole',
        'all-on-4-opole': 'All-on-4 / All-on-6 in Opole',
        'licowki-opole': 'Veneers in Opole',
        'metamorfoza-usmiechu-opole': 'Smile Makeover in Opole',
    ...
    de: {
        ...
        laser: 'Laserzahnheilkunde',
        periodontologia: 'Parodontologie',
        'stomatologia-dziecieca': 'Kinderzahnheilkunde',
        'stomatologia-zachowawcza': 'Konservierende Zahnheilkunde',
        ...
        nowosielski: 'Marcin Nowosielski Blog',
        ...
        'all-on-4-opole': 'All-on-4 / All-on-6 in Opole',
        'licowki-opole': 'Veneers in Opole',
        'metamorfoza-usmiechu-opole': 'Lächeln-Metamorphose in Opole',
    ...
    ua: {
        ...
        laser: 'Лазерна стоматологія',
        periodontologia: 'Пародонтологія',
        'stomatologia-dziecieca': 'Дитяча стоматологія',
        'stomatologia-zachowawcza': 'Терапевтична стоматологія',
        ...
        'all-on-4-opole': 'All-on-4 / All-on-6 в Ополе',
        'licowki-opole': 'Вініри в Ополе',
        'metamorfoza-usmiechu-opole': 'Метаморфоза посмішки в Ополе',
