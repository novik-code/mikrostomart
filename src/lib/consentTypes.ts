...
export const CONSENT_TYPES: Record<string, ConsentType> = {
    ...
    higienizacja: {
        ...
        fields: {
            ...
            pesel: { startX: 166.4, y: 576.4, boxWidth: 21.0, fontSize: 9, page: 1 },
    ...
    znieczulenie: {
        ...
        fields: {
            ...
            pesel: { startX: 168.8, y: 554.4, boxWidth: 21.0, fontSize: 9, page: 1 },
    ...
    chirurgiczne: {
        ...
        fields: {
            ...
            pesel: { startX: 168.3, y: 599.9, boxWidth: 21.0, fontSize: 9, page: 1 },
    ...
    protetyczne: {
        ...
        fields: {
            ...
            pesel: { startX: 150.6, y: 575, boxWidth: 21.0, fontSize: 9, page: 1 },
    ...
    endodontyczne: {
        ...
        fields: {
            ...
            pesel: { startX: 163.1, y: 571.6, boxWidth: 21.0, fontSize: 9, page: 1 },
    ...
    zachowawcze: {
        ...
        fields: {
            ...
            pesel: { startX: 147.7, y: 558.7, boxWidth: 21.0, fontSize: 9, page: 1 },
    ...
    protetyka_implant: {
        ...
        fields: {
            ...
            pesel: { startX: 86.8, y: 660.6, boxWidth: 21.0, fontSize: 9, page: 1 },
    ...
    rtg: {
        ...
        fields: {
            ...
            pesel: { startX: 184.7, y: 496, boxWidth: 21.0, fontSize: 9, page: 1 },
    ...
    implantacja: {
        ...
        fields: {
            ...
            pesel: { startX: 70, y: 534.7, boxWidth: 21.0, fontSize: 9, page: 1 },
