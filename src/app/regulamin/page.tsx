    ...
    return (
        <main className="min-h-screen pt-24 pb-12 px-4 md:px-8 max-w-4xl mx-auto text-white">
            ...
            <div className="prose prose-invert prose-gold max-w-none bg-[#1a1d21] p-8 rounded-2xl border border-white/10 text-gray-300 leading-relaxed">
                ...
                <p className="mb-4">
                    3. Miejscem udzielania świadczeń zdrowotnych, zgodnie z niniejszym Regulaminem, jest siedziba Usługodawcy: <strong>ul. Centralna 33a, 45-940 Opole/Chmielowice, woj. opolskie, Polska</strong>
                </p>
                <p className="mb-4">
                ...
                <h3 className="text-[#dcb14a] font-bold mt-8 mb-2">§ 2. Definicje</h3>
                <p className="mb-2">Użyte w niniejszym Regulaminie pojęcia i definicje będą miały następujące znaczenie:</p>
                ...
                <h3 className="text-[#dcb14a] font-bold mt-8 mb-2">§ 3. Cele i zadania Usługodawcy</h3>
                <p className="mb-4">1. Podstawowym celem Usługodawcy jest udzielanie świadczeń zdrowotnych przez osoby do tego uprawnione na podstawie przepisów prawa. Personel zatrudniony przez Usługodawcę dzieli się na personel medyczny i niemedyczny.</p>
                <p className="mb-2">2. Do podstawowych zadań Usługodawcy należy świadczenie Usług stomatologicznych opisanych w § 5 ust. 1 poniżej. Należy wśród nich wyszczególnić:</p>
                ...
                <h3 className="text-[#dcb14a] font-bold mt-8 mb-2">§ 4. Struktura organizacyjna Usługodawcy</h3>
                <p className="mb-2">1. Usługodawca jako Podmiot leczniczy prowadzi swoją działalność w ramach Gabinetu.</p>
                <p className="mb-2">2. Usługodawcą jest Spółka ELMAR SPÓŁKA Z OGRANICZONĄ ODPOWIEDZIALNOŚCIĄ z siedzibą w Opolu, ul. Centralna nr 33A, 45-940 Opole, NIP:7543251709, KRS: 0000815074 reprezentowana przez Zarząd w składzie Marcin Nowosielski i Elżbieta Nowosielska. Każdy z członków Zarządu jest uprawniony jednoosobowego reprezentowania podmiotu oraz składania za podmiot oświadczeń woli w zakresie praw i obowiązków majątkowych spółki Usługodawcy.</p>
                <p className="mb-2">3. Komórki organizacyjne Usługodawcy w ramach Gabinetu:</p>
                ...
                <p className="mb-2">4. Zadaniem recepcji jest realizacja obowiązków personelu niemedycznego zgodnie z postanowieniami niniejszego Regulaminu.</p>
                <p className="mb-2">5. Zadaniem pracowni implantologii, protetyki, endodoncji, pedodoncji, anestezji, periodontologii, ortodoncji, chirurgii jest: udzielanie świadczeń zdrowotnych specjalistycznych z zakresu stomatologii, prowadzenie dokumentacji medycznej, informowanie o zakresie i zasadach udzielania świadczeń zdrowotnych przez Usługodawcę.</p>
                <p className="mb-4">6. Zadaniem pracowni RTG jest: prowadzenie wyspecjalizowanej diagnostyski przy wykorzystaniu promieniowania rentgenowskiego.</p>

                <h3 className="text-[#dcb14a] font-bold mt-8 mb-2">§ 5. Zakres udzielanych świadczeń zdrowotnych</h3>
                <p className="mb-2">1. Usługodawca świadczy usługi stomatologiczne w zakresie:</p>
                <ul className="list-disc pl-5 space-y-1 mb-2">
                    <li>implantologii,</li>
                    <li>protetyki,</li>
                    <li>endodoncji,</li>
                ...
                <p className="mb-2">2. Do podstawowego zakresu obowiązków personelu medycznego zatrudnionego przez Usługodawcę w Gabinecie należy:</p>
                <ul className="list-disc pl-5 space-y-1 mb-2">
                ...
                <p className="mb-2">3. Do podstawowego zakresu obowiązków personelu niemedycznego zatrudnionego przez Usługodawcę w Gabinecie należy:</p>
                <ul className="list-disc pl-5 space-y-1 mb-4">
                ...
                <h3 className="text-[#dcb14a] font-bold mt-8 mb-2">§ 6. Organizacja i przebieg udzielania świadczeń zdrowotnych</h3>
                <p className="mb-4">1. Usługodawca oferuje w ramach poradni usługi stomatologiczne na  zasadzie pełnej odpłatności za spełniane świadczenia zdrowotne. Usługodawca w Gabinecie Stomatologicznym Mikrostomart prowadzi praktyką prywatną i nie udziela świadczeń w ramach świadczeń z Narodowego Funduszu Zdrowia.</p>
                <p className="mb-4">2. Realizacja świadczeń zdrowotnych następuje na zasadzie dobrowolności wyboru leczenia odpłatnego przez Pacjenta i za jego pisemną zgodą.</p>
                <p className="mb-4">3. Przyjęcie Pacjenta do Gabinetu wymaga prowadzenia jego dokumentacji medycznej, oraz dokumentacji statystycznej. Dokumentacja jest prowadzona również w systemie elektronicznym.</p>
                <p className="mb-4">4. Każdemu Pacjentowi przez pierwszą wizytą w Gabinecie zakłada się kartę rejestracyjną. Każda wizyta Pacjenta w Gabinecie musi być zapisana w dokumentacji medycznej.</p>
                ...
                <p className="mb-4">8. Odmowa Pacjenta poddania się leczeniu, w razie stwierdzenia niezwłocznej potrzeby leczenia przez Personel, podlega wpisowi do karty Pacjenta i powinna być przez niego potwierdzona.</p>
                <p className="mb-4">9. Dokumentacja medyczna prowadzona jest na zasadach określonych w przepisach odbrębnych.</p>
                ...
                <p className="mb-4">11. Pacjent przyjmuje do wiadomości, że z przyczyn losowych niezależnych od Usługodawcy, godzina umówionej w Gabinecie wizyty może ulec zmianie (opóźnieniu). W takiej sytuacji Pacjentowi nie przesługuje żadna rekompensata od Usługodawcy.</p>
                <p className="mb-4">12. W sytuacji, że planowana Usługa nie może być zrealizowana przez członka personelu medycznego, do którego Pacjent został umówiony, możliwe jest jej wykonanie przez innego członka personelu medycznego zatrudnionego przez Usługodawcę w Gabinecie, za uprzednią zgodą pacjenta.</p>
                ...
                <h3 className="text-[#dcb14a] font-bold mt-8 mb-2">§ 7. Standardy Higieniczne</h3>
                <p className="mb-2">1. Personel zatrudniony przez Usługodawcę ściśle przestrzega wymogów sanitarnych w zakresie utrzymania porządku i obowiązku dezynfekcji powierzchni w Gabinecie.</p>
                <p className="mb-2">2. Pracownicy Usługodawcy podczas wykonywania zabiegów używają rękawiczek jednorazowych, a jeżeli zabieg tego wymaga również maseczek jednorazowych.</p>
                <p className="mb-2">3. Narzędzia używane podczas Zabiegów są jednorazowe. W przypadku konieczności użycia narzędzi wielorazowych, są ona każdorazowo po użyciu poddawane sterylizacji w autoklawie, który Usługodawca posiada na wyposażeniu Gabinetu.</p>
                <p className="mb-4">4. Do sterylizacji, dezynfekcji i czyszczenia używane są wyłącznie środki dopuszczone do stosowania w gabinetach dentystycznych.</p>

                <h3 className="text-[#dcb14a] font-bold mt-8 mb-2">§ 8. Prawa i obowiązki Pacjentów</h3>
                <p className="mb-2">1. Każdy Pacjent ma prawo:</p>
                <ul className="list-disc pl-5 space-y-1 mb-2">
                ...
                <p className="mb-2">2. Uprawnienia Pacjentów wymienione w ust. 1 powyżej mogą być ograniczone wyłącznie w zakresie i sytuacjach wynikających z przepisów prawa powszechnie obowiązującego.</p>
                <p className="mb-2">3. Każdy Pacjent jest zobowiązany do:</p>
                <ul className="list-disc pl-5 space-y-1 mb-2">
                ...
                <p className="mb-2">4. Urządzenia i sprzęt znajdujący się na wyposażeniu Gabinetu Usługodawcy mogą być obsługiwane wyłącznie przez Personel. W przypadku nieuprawnionego użycia, urządzeń lub sprzętu znajdującego się na wyposażeniu Gabinetu Usługodawcy, w tym zmiany ich ustawień, przez Pacjenta, Usługodawca może dochodzić od takiego Pacjenta naprawienia szkody z tego wynikłej na zasadach ogólnych.</p>
                <p className="mb-2">5. Zabrania się Pacjentom wchodzenia do pomieszczeń przeznaczonych wyłącznie dla Personelu.</p>
                <p className="mb-4">6. Pacjenci zobowiązani są do zachowania czystości na terenie Gabinetu Usługodawcy i w jego bezpośrednim sąsiedztwie. Nie wolno Pacjentom oraz osobom im towarzyszącym zanieczyszczać oraz zaśmiecać terenu Gabinetu oraz terenu przyległego.</p>

                <h3 className="text-[#dcb14a] font-bold mt-8 mb-2">§ 9. Zasady odpłatności za świadczenia medyczne</h3>
                <p className="mb-4">1. Wszystkie Zabiegi wykonywane w Gabinecie podlegają opłacie zgodnie z Cennikiem obowiązującym u Usługodawcy. Cennik dostępny jest do wglądu w Gabinecie oraz na stronie internetowej Gabinetu Usługodawcy.</p>
                <p className="mb-4">2. Pacjent ma możliwość płatności za Usługi w salonie gotówką, przelewem, kartą, Blikiem lub specjalnym bonem zakupionym w Gabinecie Usługodawcy.</p>
                <p className="mb-4">3. W przypadku rejestracji Pacjenta wizytę, Personel pobiera od Pacjenta zadatek w wysokości ustalonej zgodnie z cennikiem, którym mowa w ust. 1 powyżej. Zadatek podlega zaliczeniu na poczet wykonanej Usługi.</p>
                ...
                <p className="mb-4">5. W przypadku braku zapłaty przez Pacjenta zadatku, o którym mowa ust. 3 powyżej, jeżeli taki Pacjent nie stawi się na umówioną wizytę, ani nie dokona zmiany terminu tej wizyty zgodnie z postanowieniami niniejszego Regulaminu, zadatek ten zostanie doliczony Pacjentowi do najbliższego rachunku.</p>
                ...
                <h3 className="text-[#dcb14a] font-bold mt-8 mb-2">§ 10. Skargi i wnioski</h3>
                <p className="mb-2">1. Pacjentowi przysługuje prawo do reklamacji Usługi.</p>
                <p className="mb-2">2. Reklamację należy złożyć na piśmie drogą mailową, osobiście w Gabinecie lub listem poleconym, maksymalnie 3 dni od jej wykonania lub wystąpienia powikłań wywołanych Zabiegiem.</p>
                <p className="mb-2">3. Usługodawca ma 14 dni kalendarzowych na rozpatrzenie reklamacji. W przypadku pozytywnego rozpatrzenia reklamacji, Usługodawca spełni żądania klienta.</p>
                <p className="mb-2">4. Pacjent ma prawo żądać zwrotu całości lub części kosztów Usługi albo wykonania nieodpłatnych poprawek, jeżeli reklamacja zostanie uznana za zasadną.</p>
                <p className="mb-2">5. W przypadku odpowiedzi odmownej, Pacjent ma prawo odwołać się od tej decyzji w ciągu 14 dni kalendarzowych. Na rozpatrzenie odwołania Usługodawca ma 14 dni kalendarzowych.</p>
                <p className="mb-2">6. Pacjent nie ma prawa odmówić zapłaty za wykonaną Usługę.</p>
                ...
                <h3 className="text-[#dcb14a] font-bold mt-8 mb-2">§ 11. Dane osobowe</h3>
                <p className="mb-4">Dane osobowe Pacjenta przetwarzane są zgodnie z treścią i w celach wskazanych w klauzuli informacyjnej, z którą Pacjent zapoznaje się podczas pierwszej wizyty w Gabinecie Usługodawcy.</p>

                <h3 className="text-[#dcb14a] font-bold mt-8 mb-2">§ 12. Postanowienia Końcowe</h3>
                <p className="mb-2">1. W celu zapewnienia prawidłowości leczenia Pacjentów oraz ciągłości przebiegu procesu udzielania świadczeń zdrowotnych, Usługodawca współdziała z innymi podmiotami wykonującymi działalność leczniczą lub udzielającymi świadczeń zdrowotnych na rzecz tych pacjentów, w szczególności Personel może żądać zaświadczenia o braku przeciwwskazań lekarskich do wskazanej Usługi/Zabiegu. Współdziałanie Usługodawcy z innymi podmiotami wykonującymi działalność leczniczą odbywa się z poszanowaniem obowiązujących przepisów prawa oraz z poszanowaniem praw Pacjenta.</p>
                <p className="mb-2">2. Każdy Pacjent ma prawo wglądu do Regulaminu, cennika i certyfikatów, na które powołuje się Usługodawca.</p>
                <p className="mb-2">3. Za wszelkie uszkodzenia wyposażenia Usługodawcy w Gabinecie Pacjenci odpowiadają bez ograniczeń zgodnie z art. 415 kodeksu cywilnego. Za uszkodzenia spowodowane przez osoby niepełnoletnie odpowiedzialni są ich ustawowi przedstawiciele.</p>
                <p className="mb-2">4. Usługodawca zastrzega sobie prawo do zmian w niniejszym Regulaminie i poinformowania o nich Pacjenta przed zapisem na wizytę, z ważnych przyczyn to jest np.: zmiany przepisów prawa, zmiany sposobów płatności, zmiany w świadczeniu usług – w zakresie, w jakim te zmiany wpływają na realizację postanowień niniejszego Regulaminu. Nowy regulamin wchodzi w życie z dniem wywieszenia go w Gabinecie.</p>
                <p className="mb-2">5. Informacja o zmianach Regulaminy zostanie opublikowana na stronie internetowej Gabinetu oraz na profilach Gabinetu w mediach społecznościowych, jeżeli takie są prowadzone, co najmniej 14 dni kalendarzowych przed terminem, w którym zmiany zaczną obowiązywać.</p>
                <p className="mb-2">6. Do Usług/Zabiegów zleconych przed dniem wejścia w życie zmian Regulaminu, obowiązują jego postanowienia obowiązujące w chwili umawiania terminu wykonania Usługi/Zabiegu.</p>
                <p className="mb-2">7. Wszelkie spory wynikające ze świadczonych Usług winny być w pierwszej kolejności rozwiązywane polubownie. W przypadku niedojścia do porozumienia spory będą rozstrzygane przez sąd właściwy wg przepisów polskiego prawa.</p>
                <p className="mb-2">8. Jeżeli którekolwiek z postanowień niniejszego Regulaminu zostałoby uznane za nieważne, niezgodne z przepisami prawa lub niewykonalne, zostanie ono wyłączone z postanowień niniejszego Regulaminu, które to w dalszym ciągu będą obowiązywać w najszerszym, dopuszczalnym przez polskie prawo zakresie.</p>
                <p className="mb-2">9. W zakresie nieuregulowanym niniejszym Regulaminem zastosowanie mają przepisy prawa polskiego.</p>
                <p className="mb-4">10. Niniejszy Regulamin obowiązuje od 01.01.2025 r.</p>
            </div>
        </main>
    );
}
