...
export default function AdminPage() {
    ...
    const [activeTab, setActiveTab] = useState<'dashboard' | 'products' | 'questions' | 'articles' | 'news' | 'orders' | 'reservations' | 'blog' | 'patients' | 'sms-reminders' | 'sms-post-visit' | 'appointment-instructions' | 'roles' | 'employees' | 'chat' | 'theme' | 'push'>('dashboard');
