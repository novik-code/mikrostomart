                    ...
                    {weekAfterCronResult && (
                        <div style={{ fontSize: '0.78rem', padding: '0.3rem 0.7rem', borderRadius: '0.4rem', background: weekAfterCronResult.error ? 'rgba(239,68,68,0.1)' : 'rgba(34,197,94,0.1)', border: `1px solid ${weekAfterCronResult.error ? 'rgba(239,68,68,0.3)' : 'rgba(34,197,94,0.3)'}`, color: weekAfterCronResult.error ? '#ef4444' : '#22c55e' }}>
                            {weekAfterCronResult.error
                                ? `❌ ${weekAfterCronResult.error}`
                                : `✅ Wysłano: ${weekAfterCronResult.sent ?? 0} | Pominięto: ${weekAfterCronResult.skipped ?? 0} | Błędy: ${weekAfterCronResult.failed ?? 0}${weekAfterCronResult.targetDate ? ` | Data: ${weekAfterCronResult.targetDate}` : ''}`
                            }
                        </div>
                    )}
                </div>
                    ...
                    <div>
                        <div style={{ display: 'flex', gap: '1rem', marginBottom: '1rem', flexWrap: 'wrap', alignItems: 'center' }}>
                            <input value={weekAfterSearch} onChange={e => setWeekAfterSearch(e.target.value)}
                                placeholder="Szukaj pacjenta, lekarza..." style={{ ...inputS, maxWidth: '320px', padding: '0.5rem 0.8rem' }} />
                            <div style={{ fontSize: '0.78rem', color: 'rgba(255,255,255,0.4)', display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                                ...
                                <div key={sms.id} style={{ ...cardStyle, marginBottom: 0, padding: '0.85rem 1rem' }}>
                                    <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'flex-start' }}>
                                        <div style={{ flex: 1, minWidth: 0 }}>
                                            ...
                                            {sms.send_error && (
                                                <div style={{ fontSize: '0.68rem', color: '#ef4444', marginTop: '0.3rem' }}>⚠ {sms.send_error}</div>
                                            )}
                                        </div>
                                    </div>
                                </div>
