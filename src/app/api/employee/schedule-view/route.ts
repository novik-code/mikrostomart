// GET /api/employee/schedule-view?month=YYYY-MM
// Read-only widok grafiku miesiąca dla strefy pracownika.
// Każdy zalogowany pracownik widzi pełen grafik (jak admin), ale bez
// żadnych mutacji. Endpoint nie zwraca sekretów (qr_secret w workstations
// nie istnieje — workstations bez sekretów).
