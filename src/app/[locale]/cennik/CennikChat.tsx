...
/**
 * CennikChat — client island wyciągnięty z page.tsx podczas K-6 (2026-05-21 NIGHT+1).
 *
 * Page.tsx jest teraz server component z SSR-rendered Hero + Kategorie + FAQ
 * (Googlebot widzi wszystko bez JS). CennikChat to interactive AI dla deep-dive wycen.
 *
 * Anchor `id="asystent-ai"` używany przez CTA buttons z kategorii cards
 * ("Zapytaj o wycenę →") oraz hero CTA.
 */
export default function CennikChat() {
    ...
    return (
        <div id="asystent-ai" style={{ scrollMarginTop: "var(--spacing-xl)" }}>
            {/* Category Pills */}
