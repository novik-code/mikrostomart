...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
    ...
    return pageMetadata(locale, '/oferta/stomatologia-zachowawcza', PAGE_SEO['/oferta/stomatologia-zachowawcza']);
}
...
export default async function Layout({
    ...
    const schemas = buildServicePageSchemas('/oferta/stomatologia-zachowawcza', locale);
