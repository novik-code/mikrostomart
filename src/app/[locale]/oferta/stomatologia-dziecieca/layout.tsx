...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
    ...
    return pageMetadata(locale, '/oferta/stomatologia-dziecieca', PAGE_SEO['/oferta/stomatologia-dziecieca']);
}
...
export default async function Layout({
    ...
    const breadcrumb = localizedBreadcrumb(locale, [
        ...
        { key: 'stomatologia-dziecieca' },
    ]);
    const schemas = buildServicePageSchemas('/oferta/stomatologia-dziecieca', locale);
