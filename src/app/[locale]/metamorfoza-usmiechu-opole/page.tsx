...
/**
 * /metamorfoza-usmiechu-opole — Faza 2D premium local geo page (2026-06-08).
 *
 * Cel: ranking na geo queries "metamorfoza uśmiechu Opole", "projektowanie uśmiechu Opole",
 * "smile makeover Opole". PL-only indexable, foreign noindex (layout). Komplementarny do
 * /metamorfozy (content hub) i /oferta/stomatologia-estetyczna. Wzorzec implanty-opole.
 */
export default async function MetamorfozaUsmiechuOpolePage({ params }: { params: Promise<{ locale: string }> }) {
                ...
                <div className="container" style={{ maxWidth: '900px', textAlign: 'center' }}>
                    <RevealOnScroll priority>
                        ...
                        <div style={{ display: 'flex', gap: 'var(--spacing-sm)', justifyContent: 'center', flexWrap: 'wrap' }}>
                            ...
                            <Link href="/metamorfozy" style={{ display: 'inline-block', background: 'transparent', color: 'var(--color-text-main)', padding: '1rem 2.5rem', fontSize: '1.05rem', fontWeight: 600, textDecoration: 'none', borderRadius: '2px', letterSpacing: '0.05em', textTransform: 'uppercase', border: '1px solid var(--color-surface-hover)' }}>
                                {t('heroCtaSecondary')}
                            </Link>
                        </div>
                    </RevealOnScroll>
            ...
            <section style={{ padding: 'var(--spacing-xl) 0', background: 'var(--color-surface)' }}>
                <div className="container" style={{ maxWidth: '820px' }}>
                    ...
                    <p style={{ textAlign: 'center', marginTop: 'var(--spacing-md)', color: 'var(--color-text-muted)', fontSize: '0.95rem' }}>
                        {t('procedureDeepLink')}{' '}
                        <Link href="/metamorfozy" style={{ color: 'var(--color-primary)', fontWeight: 600 }}>{t('procedureDeepLinkLabel')}</Link>
                    </p>
                </div>
            </section>
