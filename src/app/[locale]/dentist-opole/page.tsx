...
/**
 * /dentist-opole — Pakiet C (2026-06-01) dedykowany geo-landing pod EN rynek.
 *
 * Indexed only EN (PL/DE/UA noindex w layout.tsx). Struktura jak dentysta-opole-centrum
 * (broad-scope), treść z namespace dentistOpole (kopia centrum + EN hero override).
 */
export default async function DentistOpolePage({ params }: { params: Promise<{ locale: string }> }) {
