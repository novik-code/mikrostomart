...
/**
 * /zahnarzt-opole — Pakiet C (2026-06-01) dedykowany geo-landing pod DE rynek.
 *
 * Indexed only DE (PL/EN/UA noindex w layout.tsx). Struktura jak dentysta-opole-centrum
 * (broad-scope), treść z namespace zahnarztOpole (kopia centrum + DE hero override).
 */
export default async function ZahnarztOpolePage({ params }: { params: Promise<{ locale: string }> }) {
            ...
            <section style={{ padding: 'var(--spacing-xl) 0' }}>
                <div className="container" style={{ maxWidth: '900px' }}>
                    ...
                    <p style={{ textAlign: 'center', marginTop: 'var(--spacing-md)', fontSize: '0.95rem' }}>
                        <Link href="/cennik" style={{ color: 'var(--color-primary)', fontWeight: 600 }}>{t('heroCtaSecondary')} →</Link>
                    </p>
                </div>
            </section>
